...
namespace CodeFission.Utils.Gps
{
    public static class CalcService
    {
        public static class LibraryInfo
        {
            public static readonly double Version = 1.0.0;
            public static readonly string ApplicationName = "GPS Library";
            public static readonly string Copyright = "Copyright 2009-2020 © J. Wilson.";
            public static readonly string Website = "jonny.uk";
            public static readonly string Developer = "Jonny Wilson";
            public static readonly string License = "FREE";
            public static readonly string Description = "A library of useful convertors and data marshallers for Global Positioning applications";
        }
